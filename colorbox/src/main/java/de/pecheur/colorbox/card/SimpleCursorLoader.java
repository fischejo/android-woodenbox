...
/**
 * A loader that queries the {@link android.content.ContentResolver} and returns a {@link android.database.Cursor}.
...
public class SimpleCursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        writer.print(prefix); writer.print("mContentChanged="); writer.println(getContext());
    }
}
